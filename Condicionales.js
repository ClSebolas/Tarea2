...
if (numero1 > numero2) {
    if(numero1 > numero3){
        console.log('El numero1 es el mayor de los 3')
    }else{console.log('El numero3 es el mayor de los 3')}
}else{if(numero2 > numero3){    
        console.log('El numero2 es el mayor de los 3')
    }else{console.log('El numero3 es el mayor de los 3')}   
}
...
if (numero1 < numero2) {
    if(numero1 < numero3){
        console.log('El numero1 es el menor de los 3')
    }else{console.log('El numero3 es el menor de los 3')}
}else{if(numero2 < numero3){    
        console.log('El numero2 es el menor de los 3')
    }else{console.log('El numero3 es el menor de los 3')}   
}
